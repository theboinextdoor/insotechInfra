...
export default function OfficeLocationsPage() {
  ...
  return (
    <section className="py-12 md:py-20 bg-[#F5F5DC] dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        <ContentHeading
          heading="Our Global Footprint"
          className="text-base font-semibold uppercase tracking-wide bg-gradient-to-r from-black/60 to-orange-400 bg-clip-text text-transparent font-barlow"
          lineWidth={400}
        />
        <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight bg-gradient-to-r from-black/60 to-orange-400  bg-clip-text text-transparent">
